...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#a812dc38#;
   ...
   u00214 : constant Version_32 := 16#859bd72e#;
   pragma Export (C, u00214, "templates_test_suiteB");
   u00215 : constant Version_32 := 16#97313181#;
   pragma Export (C, u00215, "templates_test_suiteS");
   u00216 : constant Version_32 := 16#5e3c0aed#;
   pragma Export (C, u00216, "templates_diagnostics_testsB");
   u00217 : constant Version_32 := 16#804d9093#;
   pragma Export (C, u00217, "templates_diagnostics_testsS");
   u00218 : constant Version_32 := 16#78683681#;
   ...
   u00222 : constant Version_32 := 16#f7370ce4#;
   pragma Export (C, u00222, "templatesB");
   u00223 : constant Version_32 := 16#06ee5463#;
   pragma Export (C, u00223, "templatesS");
   ...
   u00228 : constant Version_32 := 16#74e05d89#;
   pragma Export (C, u00228, "templates__astB");
   u00229 : constant Version_32 := 16#a8e53c8e#;
   pragma Export (C, u00229, "templates__astS");
   u00230 : constant Version_32 := 16#c3b32edd#;
   pragma Export (C, u00230, "ada__containers__helpersB");
   u00231 : constant Version_32 := 16#444c93c2#;
   pragma Export (C, u00231, "ada__containers__helpersS");
   u00232 : constant Version_32 := 16#52627794#;
   pragma Export (C, u00232, "system__atomic_countersB");
   u00233 : constant Version_32 := 16#c83084cc#;
   pragma Export (C, u00233, "system__atomic_countersS");
   ...
   u00236 : constant Version_32 := 16#e259c480#;
   pragma Export (C, u00236, "system__assertionsB");
   u00237 : constant Version_32 := 16#322b1494#;
   pragma Export (C, u00237, "system__assertionsS");
   u00238 : constant Version_32 := 16#8b2c6428#;
   pragma Export (C, u00238, "ada__assertionsB");
   u00239 : constant Version_32 := 16#cc3ec2fd#;
   pragma Export (C, u00239, "ada__assertionsS");
   u00240 : constant Version_32 := 16#80a70283#;
   pragma Export (C, u00240, "templates__parserB");
   u00241 : constant Version_32 := 16#a9c362b7#;
   pragma Export (C, u00241, "templates__parserS");
   u00242 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00242, "system__concat_3B");
   u00243 : constant Version_32 := 16#9e5272ad#;
   pragma Export (C, u00243, "system__concat_3S");
   u00244 : constant Version_32 := 16#bcc987d2#;
   pragma Export (C, u00244, "system__concat_4B");
   u00245 : constant Version_32 := 16#27d03431#;
   pragma Export (C, u00245, "system__concat_4S");
   u00246 : constant Version_32 := 16#2436f58a#;
   pragma Export (C, u00246, "templates__diagnosticsB");
   u00247 : constant Version_32 := 16#e2e10626#;
   pragma Export (C, u00247, "templates__diagnosticsS");
   u00248 : constant Version_32 := 16#02cecc7b#;
   pragma Export (C, u00248, "system__concat_6B");
   u00249 : constant Version_32 := 16#967a9a07#;
   pragma Export (C, u00249, "system__concat_6S");
   u00250 : constant Version_32 := 16#5e15dd3f#;
   pragma Export (C, u00250, "templates__rendererB");
   u00251 : constant Version_32 := 16#b48edad3#;
   pragma Export (C, u00251, "templates__rendererS");
   u00252 : constant Version_32 := 16#162b4b81#;
   pragma Export (C, u00252, "templates__htmlB");
   u00253 : constant Version_32 := 16#3a2ec2bc#;
   pragma Export (C, u00253, "templates__htmlS");
   u00254 : constant Version_32 := 16#a8cc512a#;
   pragma Export (C, u00254, "templates__valuesB");
   u00255 : constant Version_32 := 16#c6d0d52e#;
   pragma Export (C, u00255, "templates__valuesS");
   u00256 : constant Version_32 := 16#b3f7543e#;
   pragma Export (C, u00256, "system__strings__stream_opsB");
   u00257 : constant Version_32 := 16#46dadf54#;
   pragma Export (C, u00257, "system__strings__stream_opsS");
   u00258 : constant Version_32 := 16#20ce6289#;
   pragma Export (C, u00258, "templates_html_testsB");
   u00259 : constant Version_32 := 16#795252a8#;
   pragma Export (C, u00259, "templates_html_testsS");
   u00260 : constant Version_32 := 16#d2f494aa#;
   pragma Export (C, u00260, "templates_parser_testsB");
   u00261 : constant Version_32 := 16#ce166db1#;
   pragma Export (C, u00261, "templates_parser_testsS");
   u00262 : constant Version_32 := 16#ca878138#;
   pragma Export (C, u00262, "system__concat_2B");
   u00263 : constant Version_32 := 16#a1d318f8#;
   pragma Export (C, u00263, "system__concat_2S");
   u00264 : constant Version_32 := 16#d955a948#;
   pragma Export (C, u00264, "templates_public_testsB");
   u00265 : constant Version_32 := 16#350658e6#;
   pragma Export (C, u00265, "templates_public_testsS");
   u00266 : constant Version_32 := 16#38132a87#;
   pragma Export (C, u00266, "templates_renderer_testsB");
   u00267 : constant Version_32 := 16#d50003fd#;
   pragma Export (C, u00267, "templates_renderer_testsS");
   u00268 : constant Version_32 := 16#58aaf28f#;
   pragma Export (C, u00268, "templates_values_testsB");
   u00269 : constant Version_32 := 16#7768c4f2#;
   pragma Export (C, u00269, "templates_values_testsS");
   ...
   --  templates.ast%s
   --  templates.ast%b
   --  templates.diagnostics%s
   --  templates.diagnostics%b
   --  templates.html%s
   --  templates.html%b
   --  templates.parser%s
   --  templates.parser%b
   --  templates.values%s
   --  templates.values%b
   --  templates.renderer%s
   --  templates.renderer%b
   --  templates%b
   --  templates_diagnostics_tests%s
   --  templates_diagnostics_tests%b
   --  templates_html_tests%s
   --  templates_html_tests%b
   --  templates_parser_tests%s
   --  templates_parser_tests%b
   --  templates_public_tests%s
   --  templates_public_tests%b
   --  templates_renderer_tests%s
   --  templates_renderer_tests%b
   --  templates_values_tests%s
   --  templates_values_tests%b
   --  templates_test_suite%s
   --  templates_test_suite%b
   --  tests%b
