pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__profile_page.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__profile_page.adb");
...
package body ada_main is
   ...
   E139 : Short_Integer; pragma Import (Ada, E139, "templates_E");
   E148 : Short_Integer; pragma Import (Ada, E148, "templates__ast_E");
   E181 : Short_Integer; pragma Import (Ada, E181, "templates__diagnostics_E");
   E187 : Short_Integer; pragma Import (Ada, E187, "templates__html_E");
   E173 : Short_Integer; pragma Import (Ada, E173, "templates__parser_E");
   E189 : Short_Integer; pragma Import (Ada, E189, "templates__values_E");
   E185 : Short_Integer; pragma Import (Ada, E185, "templates__renderer_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "templates__parser__finalize_body");
      begin
         E173 := E173 - 1;
         F1;
      end;
      ...
      declare
         procedure F2;
         pragma Import (Ada, F2, "templates__ast__finalize_spec");
      begin
         F2;
      end;
      declare
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_profile_page");
...
--  BEGIN Object file/option list
   --   /home/bent/Projekte/Ada/template/examples/obj/profile_page.o
   --   -L/home/bent/Projekte/Ada/template/examples/obj/
   --   -L/home/bent/Projekte/Ada/template/examples/obj/
