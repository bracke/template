...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_release_check" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#d4387438#;
   pragma Export (C, u00001, "release_checkB");
   ...
   u00014 : constant Version_32 := 16#c7a3de26#;
   ...
   u00017 : constant Version_32 := 16#57ff5296#;
   ...
   u00035 : constant Version_32 := 16#38e5c42b#;
   ...
   u00049 : constant Version_32 := 16#6c65bf08#;
   pragma Export (C, u00049, "system__dwarf_linesS");
   u00050 : constant Version_32 := 16#f9910acc#;
   ...
   u00052 : constant Version_32 := 16#219681aa#;
   pragma Export (C, u00052, "system__img_address_32S");
   u00053 : constant Version_32 := 16#0cb62028#;
   pragma Export (C, u00053, "system__img_address_64S");
   u00054 : constant Version_32 := 16#7da15eb1#;
   pragma Export (C, u00054, "system__img_unsS");
   u00055 : constant Version_32 := 16#20ec7aa3#;
   pragma Export (C, u00055, "system__ioB");
   u00056 : constant Version_32 := 16#8a6a9c40#;
   pragma Export (C, u00056, "system__ioS");
   u00057 : constant Version_32 := 16#e15ca368#;
   pragma Export (C, u00057, "system__mmapB");
   u00058 : constant Version_32 := 16#99159588#;
   pragma Export (C, u00058, "system__mmapS");
   u00059 : constant Version_32 := 16#367911c4#;
   pragma Export (C, u00059, "ada__io_exceptionsS");
   u00060 : constant Version_32 := 16#a2858c95#;
   pragma Export (C, u00060, "system__mmap__os_interfaceB");
   u00061 : constant Version_32 := 16#48fa74ab#;
   pragma Export (C, u00061, "system__mmap__os_interfaceS");
   u00062 : constant Version_32 := 16#f4289573#;
   pragma Export (C, u00062, "system__mmap__unixS");
   u00063 : constant Version_32 := 16#c04dcb27#;
   pragma Export (C, u00063, "system__os_libB");
   u00064 : constant Version_32 := 16#9143f49f#;
   pragma Export (C, u00064, "system__os_libS");
   u00065 : constant Version_32 := 16#94d23d25#;
   pragma Export (C, u00065, "system__atomic_operations__test_and_setB");
   u00066 : constant Version_32 := 16#57acee8e#;
   pragma Export (C, u00066, "system__atomic_operations__test_and_setS");
   u00067 : constant Version_32 := 16#d34b112a#;
   pragma Export (C, u00067, "system__atomic_operationsS");
   u00068 : constant Version_32 := 16#553a519e#;
   pragma Export (C, u00068, "system__atomic_primitivesB");
   u00069 : constant Version_32 := 16#1cf8e0ec#;
   pragma Export (C, u00069, "system__atomic_primitivesS");
   u00070 : constant Version_32 := 16#b98923bf#;
   pragma Export (C, u00070, "system__case_utilB");
   u00071 : constant Version_32 := 16#db3bbc5a#;
   pragma Export (C, u00071, "system__case_utilS");
   u00072 : constant Version_32 := 16#256dbbe5#;
   pragma Export (C, u00072, "system__stringsB");
   u00073 : constant Version_32 := 16#8faa6b17#;
   pragma Export (C, u00073, "system__stringsS");
   u00074 : constant Version_32 := 16#836ccd31#;
   pragma Export (C, u00074, "system__object_readerB");
   u00075 : constant Version_32 := 16#18bcfe16#;
   pragma Export (C, u00075, "system__object_readerS");
   u00076 : constant Version_32 := 16#75406883#;
   pragma Export (C, u00076, "system__val_lliS");
   u00077 : constant Version_32 := 16#838eea00#;
   pragma Export (C, u00077, "system__val_lluS");
   u00078 : constant Version_32 := 16#47d9a892#;
   ...
   u00082 : constant Version_32 := 16#97ef3a91#;
   pragma Export (C, u00082, "system__val_utilS");
   u00083 : constant Version_32 := 16#382ef1e7#;
   pragma Export (C, u00083, "system__exception_tracesB");
   u00084 : constant Version_32 := 16#f8b00269#;
   ...
   u00096 : constant Version_32 := 16#d3777e19#;
   pragma Export (C, u00096, "system__stack_checkingS");
   u00097 : constant Version_32 := 16#203d5282#;
   pragma Export (C, u00097, "ada__strings__mapsB");
   u00098 : constant Version_32 := 16#6feaa257#;
   pragma Export (C, u00098, "ada__strings__mapsS");
   u00099 : constant Version_32 := 16#b451a498#;
   pragma Export (C, u00099, "system__bit_opsB");
   u00100 : constant Version_32 := 16#d9dbc733#;
   pragma Export (C, u00100, "system__bit_opsS");
   u00101 : constant Version_32 := 16#b459efcb#;
   pragma Export (C, u00101, "ada__strings__maps__constantsS");
   u00102 : constant Version_32 := 16#fe7a0f2d#;
   ...
   u00182 : constant Version_32 := 16#377f12dc#;
   pragma Export (C, u00182, "project_toolsS");
   u00183 : constant Version_32 := 16#d3a0a796#;
   pragma Export (C, u00183, "project_tools__alire_manifestsB");
   u00184 : constant Version_32 := 16#8fca1293#;
   pragma Export (C, u00184, "project_tools__alire_manifestsS");
   u00185 : constant Version_32 := 16#76af435d#;
   pragma Export (C, u00185, "project_tools__alire_manifests__stagingB");
   u00186 : constant Version_32 := 16#3a6033e4#;
   pragma Export (C, u00186, "project_tools__alire_manifests__stagingS");
   u00187 : constant Version_32 := 16#5995b408#;
   pragma Export (C, u00187, "project_tools__filesB");
   u00188 : constant Version_32 := 16#f0596f03#;
   pragma Export (C, u00188, "project_tools__filesS");
   u00189 : constant Version_32 := 16#2252a12d#;
   pragma Export (C, u00189, "ada__streams__stream_ioB");
   u00190 : constant Version_32 := 16#5dc4c9e4#;
   pragma Export (C, u00190, "ada__streams__stream_ioS");
   u00191 : constant Version_32 := 16#5de653db#;
   pragma Export (C, u00191, "system__communicationB");
   u00192 : constant Version_32 := 16#bb9c8d3c#;
   pragma Export (C, u00192, "system__communicationS");
   u00193 : constant Version_32 := 16#f2d07175#;
   pragma Export (C, u00193, "project_tools__textB");
   u00194 : constant Version_32 := 16#95ccbf63#;
   pragma Export (C, u00194, "project_tools__textS");
   u00195 : constant Version_32 := 16#ca878138#;
   pragma Export (C, u00195, "system__concat_2B");
   u00196 : constant Version_32 := 16#a1d318f8#;
   pragma Export (C, u00196, "system__concat_2S");
   u00197 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00197, "system__concat_3B");
   u00198 : constant Version_32 := 16#9e5272ad#;
   pragma Export (C, u00198, "system__concat_3S");
   u00199 : constant Version_32 := 16#4a60eba1#;
   pragma Export (C, u00199, "project_tools__alire_manifests__validationB");
   u00200 : constant Version_32 := 16#68397289#;
   pragma Export (C, u00200, "project_tools__alire_manifests__validationS");
   u00201 : constant Version_32 := 16#3fd65c0d#;
   pragma Export (C, u00201, "project_tools__aunit_checksB");
   u00202 : constant Version_32 := 16#82edc63b#;
   pragma Export (C, u00202, "project_tools__aunit_checksS");
   u00203 : constant Version_32 := 16#bcc987d2#;
   pragma Export (C, u00203, "system__concat_4B");
   u00204 : constant Version_32 := 16#27d03431#;
   pragma Export (C, u00204, "system__concat_4S");
   u00205 : constant Version_32 := 16#03efddf3#;
   pragma Export (C, u00205, "project_tools__processesB");
   u00206 : constant Version_32 := 16#aa596acf#;
   pragma Export (C, u00206, "project_tools__processesS");
   u00207 : constant Version_32 := 16#ebb39bbb#;
   pragma Export (C, u00207, "system__concat_5B");
   u00208 : constant Version_32 := 16#54b1bad4#;
   pragma Export (C, u00208, "system__concat_5S");
   u00209 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00209, "gnatS");
   u00210 : constant Version_32 := 16#656efae9#;
   pragma Export (C, u00210, "gnat__os_libS");
   u00211 : constant Version_32 := 16#483ab824#;
   pragma Export (C, u00211, "project_tools__release_checksB");
   u00212 : constant Version_32 := 16#5e4f3eec#;
   pragma Export (C, u00212, "project_tools__release_checksS");
   u00213 : constant Version_32 := 16#b3f7543e#;
   pragma Export (C, u00213, "system__strings__stream_opsB");
   u00214 : constant Version_32 := 16#46dadf54#;
   pragma Export (C, u00214, "system__strings__stream_opsS");
   u00215 : constant Version_32 := 16#16d80a36#;
   pragma Export (C, u00215, "project_tools__tree_checksB");
   u00216 : constant Version_32 := 16#b70feac8#;
   pragma Export (C, u00216, "project_tools__tree_checksS");
   u00217 : constant Version_32 := 16#0ddbd91f#;
   pragma Export (C, u00217, "system__memoryB");
   u00218 : constant Version_32 := 16#0cbcf715#;
   ...
   --  project_tools.alire_manifests%s
   --  project_tools.alire_manifests.staging%s
   --  project_tools.alire_manifests.staging%b
   --  project_tools.alire_manifests.validation%s
   --  project_tools.alire_manifests.validation%b
   --  project_tools.alire_manifests%b
   --  project_tools.aunit_checks%s
   --  project_tools.aunit_checks%b
   --  project_tools.processes%s
   --  project_tools.processes%b
   --  project_tools.release_checks%s
   --  project_tools.release_checks%b
   --  project_tools.tree_checks%s
   --  project_tools.tree_checks%b
   --  release_check%b
